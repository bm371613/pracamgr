...
Wobec definicji funkcji oceniaj±cej oczekujemy, ¿e gracz \(max\) zawsze wybierze ruch prowadz±cy do syna o najwiêkszej warto¶ci, wiêc w grze o sumie zerowej gracz \(min\) bêdzie wybiera³ najmniejsze warto¶ci. Zatem warto¶ci \("minimax"\) dla wszystkich wierzcho³ków mo¿emy obliczyæ nastêpuj±co:
...
Algorytm Alfa-Beta jest ulepszeniem algorytmu minimax. Opiera siê na nastêpuj±cej obserwacji: warto¶ci \(minimax\) niektórych wierzcho³ków mog± byæ ustalone bez obliczania ich dla wszystkich potomków a¿ do li¶ci, a wiêc niektóre obliczenia poprzedniego algorytmu s± zbêdne. Oszczêdzaj±c w ten sposób czas mo¿na zwiêkszyæ g³êboko¶æ przeszukiwanego drzewa, a wiêc podj±æ lepsz± decyzjê.

Poni¿sze drzewo ilustruje sytuacjê, w której po obliczeniu warto¶ci \(minimax\) dla czê¶ci wierzcho³ków drzewa mo¿na stwierdziæ jaka jest warto¶æ korzenia.
