...
Wersja dla czterech wymagała modyfikacji.
...
Użycie takiego ulepszenia wobec przyjętej funkcji oceniającej nie pozwalałoby na wiele odcięć, dlatego sposób obliczania \(bound\) dopasowaliśmy do przyjętej funkcji oceniającej.
